...
public final class EurekaTestContainer {
  ...
  @SneakyThrows
  public EurekaTestContainer(final String image, final ServerSocket serverPort) {
    this.dockerClient = DefaultDockerClient.fromEnv().build();
    this.eurekaPortOnContainer = "8761";
    this.image = image;
    this.eurekaPortOnHost = serverPort;
  ...
  public EurekaTestContainer() {
    this("cloudready/spring-cloud-eureka-server:2.0.1-springboot2-SNAPSHOT", EurekaTestContainer.freePort());
  }
  ...
  private String createContainer() {
    ...
    final ContainerCreation containerCreation = this.dockerClient.createContainer(containerConfig);
